...
public class DaishouDetailActivity extends BaseLightStatusBarActivity implements View.OnClickListener {
    ...
    public void onSuccess(int type, BaseBean bean) {
        ...
        switch (type) {
            case HttpRequestType.DAISHOU_DEBIT_DETAIL:
                ...
                if (!TextUtils.isEmpty(mDaishouDetail.getReceiveTel().trim())) {
                    mDialReceiver.setVisibility(View.VISIBLE);
                } else {
                    mDialReceiver.setVisibility(View.INVISIBLE);
                }
