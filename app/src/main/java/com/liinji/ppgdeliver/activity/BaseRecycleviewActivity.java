 ...
 */
public abstract class BaseRecycleviewActivity extends BaseDarkStatusBarActivity implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onSuccess(int type, BaseBean bean) {
        if (type == getRecyclerViewNetType()) {
            ...
            Logger.d(String.valueOf(bean.getReturnTotalRecords()));
            TOTAL_COUNTER = Integer.valueOf(String.valueOf(bean.getReturnTotalRecords()));
