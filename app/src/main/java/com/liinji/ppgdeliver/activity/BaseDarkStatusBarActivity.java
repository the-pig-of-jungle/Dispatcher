...
/**
 * 状态栏为深色，字体为浅色，toolbar为深色
 * Created by YUEYINGSK on 2016/8/11.
 */
public abstract class BaseDarkStatusBarActivity extends AppCompatActivity implements NeedRefreshListener, HttpRequestListener, NetConnectLis ,IBaseActivity {
        ...
        if (isnetconnected) {
            ...
            SmartSnackbar.get(this).showIndefinite(getString(R.string.netconnected_failed), "设置", new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    IntentUtils.startActivityAction(BaseDarkStatusBarActivity.this, Settings.ACTION_SETTINGS);
                }
            });
        }
    }
